...
const home = () => {
  return (
    <div className="home xl:h-[115vh] h-screen w-[93%] sm:w-[80%] lg:w-[85%] xl:w-[1109px] m-auto">
      <Navbar />
      <div className="home-banner-container flex flex-col sm:flex-row justify-between xl:mt-12 md:mt-5 sm:mt-8 mt-2 items-center gap-10 m-auto">
        <div className="home-text-section lg:mt-2 md:mt-1 lg:w-[384px] md:w-[378px] sm:w-[230px] w-[px] xl:w-auto sm:text-left text-center">
          ...
          <div className="free-demo flex sm:justify-normal justify-center items-center m-auto xl:gap-6 sm:gap-3 text-center">
